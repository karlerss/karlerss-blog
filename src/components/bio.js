      ...
      {author?.name && (
          <div>
              <p>
                  ...
                  <a href={'https://raamatud.karlerss.com/'} target={'_blank'}>reading journal</a>,
                  <a href={'https://dokumendiregistrid.karlerss.com/'} target={'_blank'}>full text search from government documents</a>.
              </p>
          </div>
      )}
    </div>
